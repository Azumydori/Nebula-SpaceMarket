...
class Order(db.Model):
   ...
   account_id = Column(db.Integer, ForeignKey('account.id'))
...
class Product(db.Model):
   ...
   account_id = Column(db.Integer, ForeignKey('account.id'))
   line_Order_id = Column(db.Integer, ForeignKey('line_order.id'))
   whislist_id = relationship("Whislist")
...
class Line_Order(db.Model):
   ...
   product_id=db.Column(db.Integer, nullable=False)
   order_id = Column(db.Integer, ForeignKey('order.id'), nullable=False)
   product_id = relationship("Product")
